...
you can retrieve them either by saving from your browser the relevant linked
flight and position files or use Google `gsutil` as follows:
...
$ cd data-raw
$ gsutil cp \
    gs://pru-trajectories/sources/merged/overnight_cpr_fr24/raw_cpr_fr24_positions_2017-08-08.csv.bz2 .
```

As explained in the paper, you can use `R/extract-arrivals.R` to get to CSV files
containing only the flights and positions for your airport of initerest.
You can edit the relevant configuration values at the beginning of the script before launching it.
Yuo will get:
